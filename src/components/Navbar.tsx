      ...
      <div className="hidden md:flex items-center space-x-6">
            {navItems.map((item) => (
              <a
                ...
                className="text-[#815900] hover:text-hackathon-pink transition-colors relative group font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-hackathon-pink/50 rounded"
              >
                {item.title}
