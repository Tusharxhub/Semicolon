          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-3 gap-4 md:gap-6 max-w-sm">
                <a href="https://www.instagram.com/semicolon_2k25" aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="group relative overflow-hidden rounded-2xl bg-white/5 border border-white/10 backdrop-blur flex items-center justify-center w-14 h-14 md:w-16 md:h-16 text-white/80 hover:text-white hover:border-hackathon-pink/50 transition-all duration-300 hover:shadow-lg hover:shadow-hackathon-pink/30 hover:scale-105">
                ...
                <a href="https://www.linkedin.com/in/semi-colon-92993137b/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer" className="group relative overflow-hidden rounded-2xl bg-white/5 border border-white/10 backdrop-blur flex items-center justify-center w-14 h-14 md:w-16 md:h-16 text-white/80 hover:text-white hover:border-hackathon-pink/50 transition-all duration-300 hover:shadow-lg hover:shadow-hackathon-pink/30 hover:scale-105">
                ...
                <a href="mailto:auhackathon2025@gmail.com?subject=SemiColon%20Hackathon%20Inquiry&body=Hi%20SemiColon%20Team,%0D%0A%0D%0AI'd%20like%20to%20learn%20more%20about%20...%0D%0A%0D%0AThanks,%0D%0A" aria-label="Email" target="_blank" rel="noopener noreferrer" className="group relative overflow-hidden rounded-2xl bg-white/5 border border-white/10 backdrop-blur flex items-center justify-center w-14 h-14 md:w-16 md:h-16 text-white/80 hover:text-white hover:border-hackathon-pink/50 transition-all duration-300 hover:shadow-lg hover:shadow-hackathon-pink/30 hover:scale-105">
