	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': { '0%, 100%': { opacity: '1', boxShadow: '0 0 20px rgba(255,91,101,.7)' }, '50%': { opacity: '.7', boxShadow: '0 0 30px rgba(255,91,101,.9)' } },
				...
				'float-card': { '0%': { transform: 'translateY(0) rotate(0deg)' }, '50%': { transform: 'translateY(-10px) rotate(2deg)' }, '100%': { transform: 'translateY(0) rotate(0deg)' } },
				'pulse-border': { '0%,100%': { borderColor: 'rgba(255,91,101,.5)' }, '50%': { borderColor: 'rgba(255,91,101,1)' } },
				'blinking-stars': { '0%,100%': { opacity: '1' }, '50%': { opacity: '.3' } }
			},
			animation: {
